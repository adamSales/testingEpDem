...
\citet{Lupia2006}). And while \cite{bartels1996uninformed} shows that uniformed voters are different from their informed peers, it does not directly contest our conjecture here that voters are dispositionally better than random (at assessing economic growth, at least).
